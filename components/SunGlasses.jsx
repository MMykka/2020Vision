...
const SunGlasses = ({ product }) => {
  ...
  return (
    <div className="p-5 rounded-2xl sm:w-[240px] w-full bg-[#eaeaea]">
      <div className="relative w-full h-[200px] scale-125 ">
        <img
          src={image}
          alt={name}
      ...
      <div className="mt-1 ">
        ...
        <div className="flex gap-x-4 justify-center">
          ...
          <button className="px-5 py-3 bg-black text-white rounded-2xl">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
