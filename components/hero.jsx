...
const Hero = () => {
  return (
    <section className='relative w-full pb-10 mx-auto'>
      <div className='bg-[#e4d9b962] h-[60vh]  w-full relative mx-auto flex justify-center items-center bg-hero bg-contain'>
      <div className='flex flex-col items-center justify-center text-center w-full  h-full'>
        ...
        <div className='flex  gap-5 justify-center sm:mt-20'>
