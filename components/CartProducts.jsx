...
const CartProducts = ({ item }) => {
  ...
  const {removeFromCart, increaseAmount, decreaseAmount} = useContext(CardContext)
  return (
        ...
        <div className='w-full min-h-[150px] flex items-center gap-x-4'>
          ...
          <div className='w-full flex flex-col'>
            <div className='flex justify-between mb-2 '>
              <Link href={'/'} className='text-sm uppercase font-medium max-w-[240px] hover:underline'>{name}</Link>
